...
point_cloud_range = [0.0, -3.1415926, -5.0, 51.2, 3.1415926, 3.0] if cylinder else [-25.6, -25.6, -3.4, 25.6, 25.6, 3.0]
...
spatial_shape = [256, 256, 32] if cylinder else [512, 512, 64] #model init voxel spatial shape
...
train_pipeline = [
    ...
    dict(type='Collect3D', keys=['gt_occ', 'points', 'dataset_flag', 'lidar2ego_rotation', 'lidar2ego_translation']),
]
...
test_pipeline = [
    ...
    dict(
        ...
        is_train=False),
    dict(type='LoadOccupancy', to_float32=True, use_semantic=True, cylinder=cylinder, occ_path=occ_path, grid_size=occ_size, use_vel=False,
        unoccupied=empty_idx, pc_range=ori_point_cloud_range, RPR=point_cloud_range, cal_visible=visible_mask),
    dict(type='OccDefaultFormatBundle3D', class_names=class_names, with_label=False), 
    dict(type='Collect3D', keys=['gt_occ', 'points', 'dataset_flag', 'visible_mask', 'lidar2ego_rotation', 'lidar2ego_translation'],
...
# load_from = 'ckpts/unilidar_nu_SA_RPRT_bbuninorm_25625632_41.0_26.2.pth'
work_dir = './work_dirs/unilidar_nu_bcw_SA_RPRmin_bbuninorm_64648'    
log_config = dict(
    interval=50,
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='mm_UniLiDAR',
                name='unilidar_nu_cascade_bcw_SA_RPRmin_bbuninorm_64648',
                job_type='training',
