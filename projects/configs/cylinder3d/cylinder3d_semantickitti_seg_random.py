...
Version: Do not edit
LastEditTime: 2025-11-06 18:19:23
Description: 头部注释
FilePath: /UniLiDAR/projects/configs/cylinder3d/cylinder3d_semantickitti_seg_random.py
'''
...
model = dict(
    ...
    voxel_encoder=dict(
        ...
        in_channels= 5 if Random else 6,
...
load_from = None
work_dir = './work_dirs/unilidar_seg_cylinder3d_sktrain_RPR'    
log_config = dict(
    interval=50,
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name='unilidar_seg_cylinder3d_sktrain_randomD_RPR_4*A800',
                job_type='training',
                notes='modified',
