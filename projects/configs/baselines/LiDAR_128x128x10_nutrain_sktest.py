'''
Author: EASON XU
Date: 2024-02-01 05:32:15
LastEditors: EASON XU
Version: Do not edit
LastEditTime: 2024-02-29 06:38:56
Description: 头部注释
FilePath: /UniLiDAR/projects/configs/baselines/LiDAR_128x128x10_nutrain_sktest.py
'''
_base_ = [
...
#         point_cloud_range=point_cloud_range,
#         shift_coors=[0, 0, -0.2],),
#     dict(type='Collect3Dinput', keys=['points'])
# ]
...
load_from = 'ckpts/lidar-baseline.pth'
log_config = dict(
    interval=50,
    hooks=[
