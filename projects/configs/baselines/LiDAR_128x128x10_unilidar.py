...
Version: Do not edit
LastEditTime: 2025-01-08 05:56:28
Description: 头部注释
...
rpr_nu = [-25.6, 0, -3.4, 25.6, 51.2, 3.0]
...
train_pipeline_nu = [
    ...
    dict(type='LoadOccupancy', to_float32=True, use_semantic=True, cylinder=cylinder, occ_path=occ_path_nu, grid_size=occ_size_nu, use_vel=False,
            unoccupied=empty_idx_nu, pc_range=ori_point_cloud_range, RPR= RPR, restrict_pc_range=rpr_nu, cal_visible=visible_mask),
...
# load_from = 'ckpts/unilidar_merge_bcw_RPRmin_bbnorm_12812816_nu_38.4_21.4.pth'
work_dir = './work_dirs/unilidar_merged_bcw_RPRmin_nuxy_allnorm_12812816'
log_config = dict(
    interval=50,
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='mm_UniLiDAR',
                name='unilidar_merged_bcw_RPRmin_nuxy_allnorm_12812816',
                job_type='training',
