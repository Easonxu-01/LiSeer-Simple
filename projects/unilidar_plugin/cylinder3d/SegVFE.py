'''
Author: EASON XU
Date: 2025-05-29 02:22:19
LastEditors: EASON XU
Version: Do not edit
LastEditTime: 2025-06-05 03:41:53
Description: 头部注释
FilePath: /UniLiDAR/projects/unilidar_plugin/cylinder3d/SegVFE.py
'''
...
class SegVFE(BaseModule):
    ...
    def __init__(self,
        ...
        if with_pre_norm:
            ...
            self.pre_norm = self.pre_norm.float()
        vfe_layers = []
