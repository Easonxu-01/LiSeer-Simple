...
from ...occupancy.norm import uni3d_norm_2_in
import pdb
...
class CustomResNet3D(BaseModule):
    def __init__(self,
        ...
        # self.c = nn.Conv3d(n_input_channels, self.in_planes, kernel_size=(1, 1, 1),
        #               stride=(1, 1, 1), bias=False)
        # self.d = build_norm_layer(norm_cfg, self.in_planes)[1]
        # self.e = nn.ReLU(inplace=True)
