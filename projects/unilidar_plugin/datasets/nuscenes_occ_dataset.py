...
class NuscOCCDataset(NuScenesDataset):
    def __init__(self, occ_size, pc_range, seg_label_mapping, classes, occ_root, random, repeat=1, **kwargs):
    ...
    def get_data_info(self, index):
        ...
        if self.modality['use_lidar']:
            ...
            if self.random:
                input_dict['pts_filename'] = input_dict['pts_filename'].replace('LIDAR_TOP', 'LIDAR_TOP/refine', 1)
                input_dict['pts_filename'] = input_dict['pts_filename'].replace('.bin', '.ply')
